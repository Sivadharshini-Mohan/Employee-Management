...
public class Mapper {
 ...
 public Employee employeeDtoToEmployee(EmployeeDto employeeDto) {
        Employee employee = new Employee(employeeDto.getName(), employeeDto.getId(), 
            ...
            employeeDto.getExperience(), employeeDto.getBatch());
        return employee;
    }

    public Employee employeeToEmployeeDto(Employee employee) {
        EmployeeDto employeeDto = new EmployeeDto(employee.getName(), employee.getId(), 
            employee.getDob(), employee.getGender(), employee.getMobileNumber(), 
            employee.getExperience(), employee.getBatch());
        return employee;
    }
}